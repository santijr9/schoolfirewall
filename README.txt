...
Se trata de un acceso web para lanzar reglas sencillas IPtables. De manera que un profesor puede abrir o cerrar Internet en el aula. Una web en concreto, puede quedar siempre activa. En nuestro caso tenemos el Moodle del centro siempre accesible. Cuando inician las clases, internet está cerrado en todas las aulas. Cuando el profesor termina de explicar, si la tarea requiere internet, puede activarlo a toda el aula.

La máquina que haga de firewall y salida del tráfico del centro, deberá tener instalado un servidor web con PHP. Se recomienda utilizar algún tipo de autenticación para que solo los profesores puedan acceder.
...
1. setuidar IPTABLES:
	...
	Tendremos que setuidar el ejecutable /sbin/iptables
		...
		(En el nostre cas, es el fitxer /sbin/xtables-multi)
